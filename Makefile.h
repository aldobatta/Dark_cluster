...
HDF4_PATH  =
HDF5_PATH  = /software/astro/hdf5/hdf5-1.8.14-intel#/usr/local/hdf5
...
FCOMP   = mpif90 #${MPI_PATH}/bin/mpif90
CCOMP   = mpicc #${MPI_PATH}/bin/mpicc
CPPCOMP = mpicxx #${MPI_PATH}/bin/mpicxx
LINK    = mpif90 #${MPI_PATH}/bin/mpif90
